(function() {
  ...
  var verticeTriangle = new Float32Array([
      ...
      +0.2, 0.7, 0.0,           0.88, 0.09, 0.57,
      +0.2, 0.5, 0.0,           0.88, 0.09, 0.57,
      0.5, +0.7, 0.0,           0.88, 0.09, 0.57,
      +0.4, 0.5, 0.0,           0.88, 0.09, 0.57,
      0.5,  0.0, 0.0,           0.88, 0.09, 0.57,
      +0.4, -0.3, 0.0,          0.88, 0.09, 0.57,
      0.5,  -0.4, 0.0,          0.88, 0.09, 0.57,
      +0.3,  -0.5, 0.0,         0.88, 0.09, 0.57,
      +0.3,  -0.75, 0.0,        0.88, 0.09, 0.57,
      +0.15,  -0.4, 0.0,        0.88, 0.09, 0.57,
      +0.2,  -0.3, 0.0,         0.88, 0.09, 0.57
  ]);
  ...
  function animasiTranslasi(){
    if (triangleX >= (0.63 - Math.abs(0.2 * 0.7 * scaleX))) arahX = -1.0;
    else if (triangleX <= (-0.63 + Math.abs(0.2 * 0.7 * scaleX))) arahX = 1.0;
    triangleX += 0.009 * arahX;
    gl.uniform1f(xHurufLocation, triangleX);
    
    if (triangleY >= (0.5 - (0.3 * 0.7))) arahY = -1.0;
    else if (triangleY <= (-0.5 + (0.3 * 0.7))) arahY = 1.0;
  ...
  function draw(){
    ...
    ac = glMatrix.vec3.fromValues(0.17, 0.41, 0.96);//nrp 05111740000196
    gl.uniform3fv(acLoc, ac);

    // Uniform for modelMatrix vektor normal
